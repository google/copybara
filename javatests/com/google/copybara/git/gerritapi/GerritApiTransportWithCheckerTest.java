...
public class GerritApiTransportWithCheckerTest {
  ...
  public void setup() throws Exception {
    ...
    transport = new GerritApiTransportWithChecker(delegate, checker);
  }
  ...
  public void testGet() throws Exception {
    ...
    verify(checker)
        .doCheck(ImmutableMap.of("path", "path/foo", "response_type", "class java.lang.String"));
  ...
  public void testGetThrowsException() throws Exception {
    doThrow(new CheckerException("Error!")).when(checker)
        .doCheck(Matchers.<ImmutableMap<String, String>> any());
    try {
      transport.get("path/foo", String.class);
      fail();
