...
public class RustCratesIoVersionListTest {
  ...
  @Test
  public void rustCrateIoVersionList_ignoreYankedFalse_listsYankedVersions() throws Exception {
    JsonObject v1 = new JsonObject();
    v1.add("name", new JsonPrimitive("example"));
    v1.add("vers", new JsonPrimitive("0.1.0"));
    v1.add("yanked", new JsonPrimitive("true"));
    ...
    VersionList versionList =
        skylark.eval(
            "version_list",
            "version_list = rust.crates_io_version_list(crate='example', ignore_yanked_versions ="
                + " False)");
