...
/**
 * Http transport interface for talking to a Gerrit host.
 *
 * TODO(malcon): We might merge this with the GitHub one. But lets see once we have something
 * working.
 */
public interface GerritApiTransport {
