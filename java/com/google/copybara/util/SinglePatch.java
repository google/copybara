...
public class SinglePatch {
   ...
   */
  public static SinglePatch generateSinglePatch(
    ...
    return new SinglePatch(hashesBuilder.buildOrThrow(), diff);
  }
  ...
  public static SinglePatch fromBytes(byte[] bytes)
    ...
    try (
      ...
      return new SinglePatch(fileHashesBuilder.buildOrThrow(), diffContentOut.toByteArray());
    }
  }
