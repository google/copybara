...
<span style="white-space: nowrap;">`--disable-consistency-merge-import`</span> | *boolean* | If merge import is set to use consistency in the config, disable it for this run. This uses an import baseline instead.
