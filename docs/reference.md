...
<code><a href="#coreconsistency_file_config">core.consistency_file_config</a></code> <code>core.consistency_file_config(<a href=#core.consistency_file_config.path>path</a>="do-not-edit.bara.consistency", <a href=#core.consistency_file_config.exclude_build_files>exclude_build_files</a>=False)</code>
