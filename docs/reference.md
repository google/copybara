...
<span style="white-space: nowrap;">`--fetch-timeout, --repo-timeout`</span> | *duration* | Fetch timeout Please use --repo-timeout over the deprecated --fetch-timeout.  Example values: 30s, 20m, 1h, etc.
