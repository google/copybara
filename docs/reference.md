...
## Table of Contents
  ...
  - [core](#core)
    ...
    - [core.consistency_file_config](#coreconsistency_file_config)
...
<span style="white-space: nowrap;">`--print-config`</span> | *boolean* | When set, the VALIDATE command will print the resolved configuration. The output is intended for human inspection and is not guaranteed to be stable.
...
<a id="core.consistency_file_config" aria-hidden="true"></a>
### core.consistency_file_config

Describes the configuration for consistency file options

<code><a href="#coreconsistency_file_config">core.consistency_file_config</a></code> <code>core.consistency_file_config(<a href=#core.consistency_file_config.path>path</a>="do-not-edit.bara.consistency", <a href=#core.consistency_file_config.exclude_build_files>exclude_build_files</a>=False, <a href=#core.consistency_file_config.patch_file_path>patch_file_path</a>=None, <a href=#core.consistency_file_config.patch_path_prefix_to_strip>patch_path_prefix_to_strip</a>=None, <a href=#core.consistency_file_config.patch_file_description>patch_file_description</a>=None)</code>


<h4 id="parameters.core.consistency_file_config">Parameters:</h4>

Parameter | Description
--------- | -----------
<span id=core.consistency_file_config.path href=#core.consistency_file_config.path>path</span> | <code><a href="#string">string</a></code><br><p>The path to the consistency file. Must end with .bara.consistency.</p>
<span id=core.consistency_file_config.exclude_build_files href=#core.consistency_file_config.exclude_build_files>exclude_build_files</span> | <code><a href="#bool">bool</a></code><br><p>Exclude BUILD files from being hashed in consistency files.</p>
<span id=core.consistency_file_config.patch_file_path href=#core.consistency_file_config.patch_file_path>patch_file_path</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>A path to the patch file in which consistency diffs get written into when not using merge import mode. When using merge import mode, diffs are written into the consistency file and this parameter is ignored. If None, defaults to the consistency file name with an additional '.patch' suffix.</p>
<span id=core.consistency_file_config.patch_path_prefix_to_strip href=#core.consistency_file_config.patch_path_prefix_to_strip>patch_path_prefix_to_strip</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>Path prefix to strip from file path headers in patch file generated by regenerate command. Use this together with the patch transformations' `directory` parameter to create and apply patches relative to a directory instead of relative to destination root. Always strips synthetic Copybara folders premerge/ and checkout/, even if None. Has no effect on file headers in consistency file if merge import mode is used. Example: value of "upstream_src/" would change file headers from a/premerge/upstream_src/file to a/file and b/checkout/upstream_src/file to b/file.</p>
<span id=core.consistency_file_config.patch_file_description href=#core.consistency_file_config.patch_file_description>patch_file_description</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>A default description to prepend to the generated explicit patch file. Does not affect the consistency file header itself. May not contain any lines looking like the beginning of diff content (starting with "+++", "---", "diff -git").</p>
...
<span id=core.merge_import_config.use_consistency_file href=#core.merge_import_config.use_consistency_file>use_consistency_file</span> | <code><a href="#bool">bool</a></code><br><p>Deprecated. Use consistency_file in core.workflow instead. When merging, if a consistency file exists, use it to construct the center of the 3-way merge. This can result in a more accurate merge in some cases, such as when the config file has changed since the last import.</p>
...
<span id=core.workflow.consistency_file href=#core.workflow.consistency_file>consistency_file</span> | <code><a href="#bool">bool</a></code> or <code><a href="#coreconsistency_file_config">core.consistency_file_config</a></code> or <code>NoneType</code><br><p>Consistency file configuration. Can be a boolean or a consistency_file_config object. If set to True, consistency file path defaults to "do-not-edit.bara.consistency".</p>
...
<h4 id="returned_by.core.consistency_file_config">Returned By:</h4>

<ul><li><a href="#core.consistency_file_config">core.consistency_file_config</a></li></ul>
<h4 id="consumed_by.core.consistency_file_config">Consumed By:</h4>
...
<code><a href="#origin">origin</a></code> <code>folder.origin(<a href=#folder.origin.materialize_outside_symlinks>materialize_outside_symlinks</a>=None, <a href=#folder.origin.inside_symlinks_mode>inside_symlinks_mode</a>=None, <a href=#folder.origin.outside_symlinks_mode>outside_symlinks_mode</a>=None, <a href=#folder.origin.broken_symlinks_mode>broken_symlinks_mode</a>=None)</code>
...
Parameter | Description
--------- | -----------
<span id=folder.origin.materialize_outside_symlinks href=#folder.origin.materialize_outside_symlinks>materialize_outside_symlinks</span> | <code><a href="#bool">bool</a></code> or <code>NoneType</code><br><p>DEPRECATED - equivalent to outside_symlinks_mode='MATERIALIZE'</p>
<span id=folder.origin.inside_symlinks_mode href=#folder.origin.inside_symlinks_mode>inside_symlinks_mode</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>How to handle symlinks pointing inside the origin folder. Possible values: 'COPY_AS_IS' (copy the symlink as-is), 'MATERIALIZE' (copy the content of the target instead of the symlink), 'IGNORE' (ignore the symlink), 'FAIL' (fail the operation). Defaults to 'COPY_AS_IS'.</p>
<span id=folder.origin.outside_symlinks_mode href=#folder.origin.outside_symlinks_mode>outside_symlinks_mode</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>How to handle symlinks pointing outside the origin folder. See inside_symlinks_mode for possible values. Defaults to 'FAIL'.</p>
<span id=folder.origin.broken_symlinks_mode href=#folder.origin.broken_symlinks_mode>broken_symlinks_mode</span> | <code><a href="#string">string</a></code> or <code>NoneType</code><br><p>How to handle broken symlinks. See inside_symlinks_mode for possible values (except 'MATERIALIZE', which is invalid for broken symlinks). Defaults to 'FAIL'.</p>
...
<span style="white-space: nowrap;">`--folder-origin-ignore-invalid-symlinks`</span> | *boolean* | DEPRECATED - equivalent to folder.origin(outside_symlinks_mode='IGNORE', broken_symlinks_mode='IGNORE')
