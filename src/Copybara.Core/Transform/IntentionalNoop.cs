...
/// </summary>
public sealed class IntentionalNoop : ITransformation
{
    public static readonly IntentionalNoop Instance = new();

    private IntentionalNoop()
    {
    }

    public TransformationStatus Transform(TransformWork work) => TransformationStatus.Success();

    public ITransformation Reverse() => this;

    public string Describe() => "no-op";
}
