...
COPYBARA_MAVEN_ARTIFACTS = [
    ...
    maven.artifact("com.google.guava", "failureaccess", "1.0.3"),
    maven.artifact("com.google.guava", "guava-testlib", "33.4.6-jre", testonly = True),
    maven.artifact("com.google.guava", "guava", "33.4.6-jre"),
